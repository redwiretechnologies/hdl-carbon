...
set_property -dict {PACKAGE_PIN A11 IOSTANDARD LVCMOS18} [get_ports {rfp_gpo_0[0]}]
set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS18} [get_ports {rfp_gpo_0[1]}]
...
set_property -dict {PACKAGE_PIN B10 IOSTANDARD LVCMOS18} [get_ports {rfp_gpo_2[0]}]
set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS18} [get_ports {rfp_gpo_2[1]}]
