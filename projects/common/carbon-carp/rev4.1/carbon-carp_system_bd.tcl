...
set_property -dict [list CONFIG.PSU__SPI0__PERIPHERAL__ENABLE {1} \
                         ...
                         CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__FREQMHZ 100 ] [get_bd_cells sys_ps8]
...
create_ip -name line_matrix -vendor redwiretechnologies.us -library user -version 1.0 -module_name line_matrix_0
set_property -dict [list CONFIG.NUM_INPUTS {8} CONFIG.NUM_OUTPUTS {10}] [get_ips line_matrix_0]
